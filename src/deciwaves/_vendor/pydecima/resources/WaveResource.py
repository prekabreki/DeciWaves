import struct
from deciwaves._vendor.pydecima.enums.EWaveDataEncoding import EWaveDataEncoding
from deciwaves._vendor.pydecima.enums.EWaveDataEncodingQuality import EWaveDataEncodingQuality
