...
Invoke as a module (package form):
    python -m engine.render --data-dir <DS:DC/data> --oodle <oo2core_7_win64.dll>
"""
...
def load_keepspans(path):
    ...
    import csv as _csv
    from engine.speech_trim import parse_spans
...
def main(argv=None):
    ...
    from engine import audio_clip
    from engine import story_order
