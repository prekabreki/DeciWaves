...
Invoke as a module (src/ must be on PYTHONPATH)::
    ...
    PYTHONPATH=src python -m games.hzd.catalog --package <...\\LocalCacheDX12\\package>
"""
...
from engine.catalog import CSV_COLUMNS, done_core_paths, processed_core_paths
from games.hzd.sentence_fw import parse_sentences_fw
from games.hzd.profile import HZD_ANCHORED_PREFIXES, HZD_FAMILY_PREFIXES
